...
今後、スタイリングの追加を予定しています。`,
  ...
  },
  {
    ...
    originUrl: 'https://github.com/code-leaf/anki-app',
    originLabel: 'PHP版',
  ...
  },
  {
    id: 10,
    title: 'Usapochi',
    description: `職業訓練でチーム開発したJava + SQLite製のAndroidアプリ「Usapochi」を、React Native・React Native Web・Supabaseを使用して移植したWebアプリケーション。AIを活用したバイブコーディングで開発し、Android版の主要なゲーム機能をWebでも利用できるようにしています。`,
    technologies: [
      'React Native',
      'React Native Web',
      'Expo',
    ...
    imageUrl: '/urlImages/usapochi.png',
    githubUrl: 'https://github.com/code-leaf/UsapochiRN',
    projectUrl: 'https://usapochi-rn.vercel.app/',
    originUrl: 'https://github.com/code-leaf/Usapochi',
    originLabel: 'Java版',
  },
] as const;
